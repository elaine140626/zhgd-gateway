package com.hujiang.project.zhgd.pdf;
...
//    }
    ...
    private Map<String,Object> getJCQRS(String ids){
        ...
        for(PdfWorkers pdf: pdfWorkers){
            if(pdf.getIsTeam()==0){//普通劳务工人
                ...
                PDFUtil pdfUtil = new PDFUtil(Util.getPath(),bzzjc);
                Map<String, Object> paraMap = new HashMap<String, Object>();
    ...
    private Map<String,Object> getTC(String ids){
        ...
        for(PdfWorkers pdf: pdfWorkers){
            if(pdf.getIsTeam()==0){//普通劳务工人
                PDFUtil pdfUtil = new PDFUtil(Util.getPath(),tc);
                Map<String, Object> paraMap = new HashMap<String, Object>();
                paraMap.put("pdf",pdf);
                try {
                ...
                PDFUtil pdfUtil = new PDFUtil(Util.getPath(),bzztc);
                Map<String, Object> paraMap = new HashMap<String, Object>();
                paraMap.put("pdf",pdf);
                try {
    ...
    private Map<String,Object> getLDHT(String ids){
        ...
        //遍历人员信息
        for(PdfWorkers pdf: pdfWorkers){
                PDFUtil pdfUtil = new PDFUtil(Util.getPath(),ldht);
                Map<String, Object> paraMap = new HashMap<String, Object>();
    ...
    private Map<String,Object> getLZ(String ids){
        ...
        //遍历人员信息
        for(PdfWorkers pdf: pdfWorkers){
            PDFUtil pdfUtil = new PDFUtil(Util.getPath(),lz);
            Map<String, Object> paraMap = new HashMap<String, Object>();
            paraMap.put("pdf",pdf);
